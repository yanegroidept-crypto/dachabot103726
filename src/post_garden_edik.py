...
Требования:
1. Пост должен быть написан полностью самостоятельно на заданную тему —
   готового текста для этой темы не существует, придумай содержание сам,
   в характере и манере Эдика (IT-сленг, структура со списком и жирным
   шрифтом, шутка про очки на лбу, призыв ставить «+» в комментариях,
...
4. Длина и структура — как в примере (не сильно короче и не сильно
   длиннее).
5. Не используй символы для выделения слов типа "**" или другие\
6. Пост длинный, не меньше 150 слов
