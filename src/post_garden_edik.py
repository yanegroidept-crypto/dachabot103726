...
Требования:
1. ПИШИ КОНКРЕТНО ПО ТЕМЕ!! Не как айтишник про технологии, а как мужик про мужскую тему. Имено как мужик мужику. И не уходи в размышления персонажа, говори 90% про тему поста
...
9. Пост должен быть написан полностью самостоятельно на заданную тему —
   ...
   в характере и манере Эдика (чуть чуть IT-сленг, но не перебор, структура со списком где каждый пункт отмечен эмодзи, призыв ставить «+» в комментариях,
